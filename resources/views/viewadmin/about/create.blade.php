...
@section('isi')
  <div class="row">
      <form class="card col s6 offset-s3" action="/createabout" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <input type="hidden" name="_method" value="PUT">
        <div class="row">
          <div class="input-field col s12">
            <input name="nama_prestasi" type="text" class="validate" required>
          ...
          <div class="row">
            <div class="input-field col s12">
              <input name="tanggal" type="text" class="datepicker" required>
